...
router
  .route("/devices/nameAvailability")
  .get(postControllers.getDevicesByNameAvailability); //for AdminDevicesScreen.js (gets deviceName, num_loaned, num_available, category)
...
// User methods
router.get(
  "/devices/nameAvailabilityUser",
  postControllers.getDevicesByNameAvailabilityUser
